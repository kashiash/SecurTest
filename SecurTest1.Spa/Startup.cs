...
namespace SecurTest1.Spa {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
          ...
          //  services.AddScoped<ISpaApplicationFactory, SpaApplicationFactory<SecurTest1SpaApplication>>();

            services.AddTransient<ISpaApplicationFactory, SpaApplicationFactory<SecurTest1SpaApplication>>();
            services.AddSingleton<ISpaApplicationConfigProvider, SpaApplicationConfigProvider>();
            //
