...
namespace SecurTest1.Web {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/DevExpressExpressAppWebWebApplicationMembersTopicAll.aspx
    public partial class SecurTest1AspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private SecurTest1.Module.SecurTest1Module module3;
        private SecurTest1.Module.Web.SecurTest1AspNetModule module4;
        ...
        static SecurTest1AspNetApplication() {
        ...
        #endregion
        public SecurTest1AspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void SecurTest1AspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new SecurTest1.Module.Web.SecurTest1AspNetModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.SecurTest1AspNetApplication_DatabaseVersionMismatch);
